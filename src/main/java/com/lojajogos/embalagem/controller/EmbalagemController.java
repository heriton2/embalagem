...
public class EmbalagemController {
    ...
    @Operation(
            ...
            description = "Recebe uma lista de pedidos com produtos e suas dimensões e retorna as caixas que devem ser usadas",
    ...
    public ResponseEntity<ResponseDTO> otimizarEmbalagens(@RequestBody Map<String, List<PedidoDTO>> request) {
