...
class EmbalagemControllerTest {
    ...
    @Mock
    private EmbalagensServiceImpl embalagensServiceMock;
    ...
    void setUp() {
        ...
        CaixaDTO caixaResponseDTO = new CaixaDTO("Caixa 1", Collections.singletonList("ProdutoX"), null);
        PedidoResponseDTO pedidoResponseDTO = new PedidoResponseDTO(1, Collections.singletonList(caixaResponseDTO));
    ...
    void processarPedidos_validRequest_shouldReturnOkWithResponse() {
        ...
        ResponseEntity<ResponseDTO> responseEntity = embalagemController.otimizarEmbalagens(requestBody);
    ...
    @Test
    @DisplayName("processarPedidos deve retornar 200 OK com ResponseDTO para lista de pedidos vazia na requisição")
    void processarPedidos_emptyPedidosListInRequest_shouldReturnOkWithPotentiallyEmptyResponse() {
        ...
        ResponseDTO emptyServiceResponseDTO = new ResponseDTO(new ArrayList<>()); // Service handles empty list
        when(embalagensServiceMock.processarPedidos(emptyPedidosList)).thenReturn(emptyServiceResponseDTO);
    ...
    @Test
    @DisplayName("processarPedidos deve retornar 200 OK e delegar tratamento de chave 'pedidos' ausente ao serviço")
