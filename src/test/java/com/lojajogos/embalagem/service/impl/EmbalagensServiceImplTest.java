...
public class EmbalagensServiceImplTest {
    ...
    @Mock
    private EmpacotamentoService empacotamentoServiceMock;

    @InjectMocks
    private EmbalagensServiceImpl embalagensService;
    ...
    void testProcessarPedidos_singlePedido() {
        ...
        assertEquals(produtoDTO1.getDimensoes().getAltura(), capturedProduto.getDimensoes().getAltura());
        assertEquals(produtoDTO1.getDimensoes().getLargura(), capturedProduto.getDimensoes().getLargura());
        assertEquals(produtoDTO1.getDimensoes().getComprimento(), capturedProduto.getDimensoes().getComprimento());
    }
    ...
    void testProcessarPedidos_multiplePedidos() {
        ...
        assertEquals(produtoDTO1.getProduto_id(), capturedPedido2.getProdutos().get(0).getId()); // First product in pedidoDTO2
        assertEquals(produtoDTO2.getProduto_id(), capturedPedido2.getProdutos().get(1).getId()); // Second product in pedidoDTO2
    }
    ...
    void testProcessarPedidos_pedidoWithEmptyProductList() {
        ...
        PedidoResponseDTO pedidoSemProdutosResponseDTO = new PedidoResponseDTO(3, Collections.emptyList());

        when(empacotamentoServiceMock.processar(any(Pedido.class))).thenReturn(pedidoSemProdutosResponseDTO);
